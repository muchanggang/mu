 ...
 */
class m170814_065929_create_goods_table extends Migration
{
    /**
     * @inheritdoc
     */
...
'is_on_sale'=>$this->integer(1)->notNull()->comment('1在售 0下架'),
//status	inter(1)integer	状态(1正常 0回收站)
'status'=>$this->integer(1)->notNull()->comment('(1正常 0回收站'),
//sort	int()	排序
'sort'=>$this->integer()->notNull()->comment('排序'),
//create_time	int()	添加时间
'create_time'=>$this->time()->notNull()->comment('添加时间'),
//view_times	int()	浏览次数
